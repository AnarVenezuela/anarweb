...
class BaseForm(SearchForm):
    ...
    def search(self):
        ...
        # Realizar la busqueda sin query
        if len(filters) > 0 and not self.cleaned_data['q']:
            sqs = SearchQuerySet()
...
class BasicForm(BaseForm):
    ...
    # Seleccion Multiple
    manifestacion.widget.attrs = {
        'class':'chzn-select', 
        'data-placeholder':'Seleccione el tipo de manifestación'
    }


########################################################################################
# Creando Advanced Form: Busqueda Avanzada
########################################################################################
...
class AdvancedForm(BasicForm):
    ...
    conservacion.widget.attrs = {
        'class':'chzn-select', 
        'data-placeholder':'Seleccione el estado de conservación'
    }
    manifasociadas.widget.attrs = {
        'class':'chzn-select', 
        'data-placeholder':'Seleccione las manifetaciones asociadas'
    }
