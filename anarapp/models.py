...
class Yacimiento(models.Model):
    ...
    estado = models.ForeignKey(Estado, 
        related_name='EstadoYac', 
        verbose_name = '3. Estado/Provincia', 
        blank = True, 
        null = True)            
    
    municipio = ChainedForeignKey(Municipio, 
        related_name='MunicipioYac', 
        verbose_name = '2. Municipio', 
        blank = True, 
        null = True,
...
class Croquis (models.Model):
    ...
    archivo = models.ImageField('6.2. Esquema de llegada - Archivo', 
        upload_to='esquema/%Y_%m', 
        null=True, 
        blank=True)
...
class Datum (models.Model):
    ...
    tipoDatum = models.IntegerField('9. Datum GPS',
        choices = OPCIONES_DATUM, 
        blank = True,
        null = True)
...
class FotografiaYac (models.Model):
    ...
    archivo = models.ImageField('11. Fotografía - Archivo', 
        upload_to='yacimiento/%Y_%m', 
        null=True, 
        blank=True)
...
class ConstitucionYacimiento (models.Model):
    ...
    nroPiedras = models.IntegerField('21.1. Nro de Piedras en el Yacimiento Original', 
        blank = True, 
        null = True)
    nroPiedrasGrabadas = models.IntegerField('21.1.1. Nro de Piedras Grabadas', 
        blank = True, 
        null = True)
    nroPiedrasPintadas = models.IntegerField('21.1.2. Nro de Piedras Pintadas', 
        blank = True, 
        null = True)
    nroPiedrasColocadas = models.IntegerField('21.1.3. Nro Piedras Colocadas', 
        blank = True, 
        null = True)
...
class MaterialYacimiento(models.Model):
    ...
    esIgnea = models.BooleanField('22.1.1. Ignea')
    esMetamor= models.BooleanField('22.1.2. Metamórfica')
    esSedimentaria = models.BooleanField('22.1.3. Sedimentaria')
    tipo = CharField('22.1.4. Tipo', blank = True)
...
class ConsiderTemp(models.Model):
    ...
    class Meta:
        verbose_name = '28. Consideraciones sobre Temporalidad'
        verbose_name_plural = '28. Consideraciones sobre Temporalidad'
...
class Piedra(models.Model):
    ...
    codigo = models.CharField('0- Codigo de la roca', 
        unique = True, 
...
class FotografiaPiedra (models.Model):
    ...
    archivo = models.ImageField('1.1. Fotografía - Archivo', 
...
class EscNatPiedra(RepGrafPiedra):
    ...
    tipoReproduccion = models.IntegerField('13.2.1. Reproducción gráfica', 
        choices = TIPO_REPRODUCCION_NATURAL)
...
class EscRedPiedra(RepGrafPiedra):
    ...
    tipoReproduccion = models.IntegerField('13.3.1. Reproducción gráfica', 
        choices = TIPO_REPRODUCCION_REDUCIDA)
...
class BibPiedra(Bibliografia):
    ...
    archivo = models.ImageField('13.4.6.1. Dibujo - Archivo', 
...
class Multimedia (models.Model):
    ...
    archivo = models.FileField('2. Multimedia - Archivo', 
        upload_to='multimedia/%Y_%m', 
        null=True, 
        blank=True)
